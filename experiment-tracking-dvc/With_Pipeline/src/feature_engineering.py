...
out_path = root_path/"data"/"processed"
...
# save processed data
train_processed.to_csv(out_path/"train_processed.csv", index=False)
test_processed.to_csv(out_path/"test_processed.csv", index=False)